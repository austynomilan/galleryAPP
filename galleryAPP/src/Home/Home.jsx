  ...
  return (
    <>
      <div className='homeContainer'>
        <Navbar onSearchChange={handleSearchChange} login={login} toggleLoginState={toggleLoginState} search={search}/>
        <div className='image_card'>
        {showLogin && <SignIn toggleLoginState={toggleLoginState}  handleCloseSignIn={handleCloseSignIn} />}
          {loading ? (
